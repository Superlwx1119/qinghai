          ...
          <div class="box">
            ...
            <div class="box-body">
              <el-form ref="searchForm" :model="searchForm" label-width="105px">
                <el-row :gutter="12">
                  <el-col :span="6">
                    <el-form-item label="栏目标题" prop="stdName">
                  ...
                  <el-col :span="6">
                    <el-form-item label="发布状态" prop="declareStatus">
                      <el-select
                        v-model="searchForm.declareStatus"
                        placeholder="请选择"
                        style="width:100%;"
                  ...
                  <el-col :span="6" style="font-size:0;text-align:right;">
          ...
          <div class="box">
            <div class="box-header handle">
              ...
              <div class="box-tools">
                ...
                <el-button type="success">新增父级标题</el-button>
              </div>
            </div>
