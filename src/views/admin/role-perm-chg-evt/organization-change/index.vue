        ...
        <div class="box-body">
          <el-form ref="searchForm" :model="searchForm" :rules="rules" label-width="90px">
            <el-row :gutter="24" style="margin-right:0!important;margin-left:0!important;">
              ...
              <el-col :md="12" :lg="8" :xl="6">
                <el-form-item label="组织机构编码" prop="orgCodg">
      ...
      <div class="box">
        ...
        <div class="box-body">
          ...
          >
            ...
            <el-table-column prop="orgName" show-overflow-tooltip label="组织机构名称" align="center" />
            <el-table-column prop="orgCodg" show-overflow-tooltip label="组织机构编码" align="center" />
            <el-table-column prop="admdvs" show-overflow-tooltip label="医保区划" align="center" />
            <el-table-column prop="abbr" show-overflow-tooltip label="简称" align="center" />
