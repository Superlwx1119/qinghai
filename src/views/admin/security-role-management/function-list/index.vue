        ...
        <el-col :span="24">
          <div class="box">
            <div class="box-header">
              <span class="box-title">可用菜单</span>
              <div class="box-tools">
                <el-form :inline="true" :model="searchForm" class="demo-form-inline">
                  ...
                  <el-form-item>
                    <el-button type="primary" @click="saveUseAbleResource">保存</el-button>
                  </el-form-item>
                </el-form>
              </div>
            </div>
    ...
    setCheckedNodes(data) {
      ...
      ApiObj.resourceTree(params).then(res => {
        if (res.code === 0) {
          ...
          this.$refs.tree.setCheckedKeys(arr)
          // res.data.forEach(item => {
          //   this.$refs.tree.setChecked(item.data.resuId, true, false)
          // })
